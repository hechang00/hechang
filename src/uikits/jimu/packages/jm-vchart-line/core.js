...
import Loading from 'v-charts/src/components/loading'
import DataEmpty from 'v-charts/src/components/data-empty'
import {
  DEFAULT_COLORS,
  DEFAULT_THEME,
  STATIC_PROPS,
  ECHARTS_SETTINGS
} from 'v-charts/src/constants'
import setExtend from 'v-charts/src/modules/extend'
import setMark from 'v-charts/src/modules/mark'
import setAnimation from 'v-charts/src/modules/animation'
...
export default {
  ...
  props: {
    ...
    xAxisFormatter: { type: Function },
    yAxisFormatter: { type: Function },
    ...
    multipleYAxis: { type: Boolean, default: false },
    log: Boolean
  },
