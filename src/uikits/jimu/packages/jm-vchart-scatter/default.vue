<template>
  <ve-scatter
    ...
    :settings="Object.assign({xAxisType:xAxisType,xAxisName:xAxisName,yAxisName:yAxisName,symbolSizeMax:symbolSizeMax,axisVisible:axisVisible,min:min,max:max,digit:digit},settings)"
    :extend="extend"
    @ready="ready"
