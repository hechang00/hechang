<template>
  <ve-ring
    ...
    :settings="Object.assign({hoverAnimation:hoverAnimation,dataType:dataType,selectedMode:selectedMode,limitShowNum:limitShowNum,digit:digit,radius:radius},settings)"
    :extend="extend"
    @ready="ready"
